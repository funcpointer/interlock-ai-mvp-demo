...
def _diff_edge_to_finding(
    ...
    return Finding(
        ...
        context_support_context_refs=context_support.context_refs if context_support else [],
        context_support_search_refs=context_support.search_refs if context_support else [],
    )
